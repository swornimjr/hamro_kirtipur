...
const listings = [
  ...
  // --- RESTAURANTS ---
  // Source: TripAdvisor, Nepalista, Kathmandu Post, JantaReview, WorldPlaces, AsisFirms (researched June 2026)
  {
    name: 'Sasa Twa',
    category: 'restaurant',
    ward: 1,
    description: 'Kirtipur\'s most celebrated Newari heritage restaurant. Traditional open courtyard, live music, bonfire, and BBQ evenings. ISO 9001 & 22000 certified. Great for groups and cultural evenings.',
    address: 'Sagal Tole-3, Kirtipur Ring Road, Kirtipur',
    phone: '9801152209',
    hours: 'Daily 10am–10pm',
    location: { type: 'Point', coordinates: [85.27262, 27.67836] },
    meta: {
      cuisine: 'Newari',
      mustTry: ['Yomari with Khuwa', 'Chatamari', 'Sapumicha', 'Choila', 'Samay Baji', 'Chyang', 'Aila'],
      features: ['Live music', 'BBQ', 'Bonfire', 'Traditional costume rental', 'Parking', 'Reservations'],
      email: 'sasatwa1140@gmail.com',
      tripadvisor: '#1 of 10 in Kirtipur, 4.0/5 (48 reviews)',
    },
    verified: true,
  },
  {
    ...
    category: 'restaurant',
    ward: 1,
    description: 'Authentic Newari community kitchen where diners sit on floor cushions and eat from dried banana leaves. Traditional cooking methods are visible, and cultural artifacts line the walls. A truly immersive experience.',
    address: 'Thambahal Ward-1, Kirtipur 44618',
    phone: '9863311456',
    hours: 'Daily (hours vary)',
    location: { type: 'Point', coordinates: [85.27438, 27.67890] },
    meta: {
      cuisine: 'Newari',
      mustTry: ['Samay Baji', 'Buff Choila', 'Barra', 'Chatamari', 'Syaphu Micha', 'Chhyang', 'Juju Dhau'],
      features: ['Floor seating', 'Banana leaf serving', 'Cultural artifacts', 'Complimentary Chhyang'],
      email: 'newalahana@gmail.com',
      tripadvisor: '#3 of 10 in Kirtipur, 3.8/5 (39 reviews)',
    },
    verified: true,
  },
  {
    name: 'Layaku Durbar Restro & Heritage Home',
    category: 'restaurant',
    ward: 1,
    description: 'Rustic heritage restaurant in the heart of Kirtipur\'s ancient old town. Budget-friendly Newari meals in a charming, old-world setting. A quieter and more affordable alternative to the bigger Newari restaurants.',
    address: 'Old Town, Kirtipur 44600',
    phone: '9851100820',
    hours: 'Daily (hours vary)',
    location: { type: 'Point', coordinates: [85.27516, 27.67922] },
    meta: {
      cuisine: 'Newari',
      mustTry: ['Steamed Buff Momo', 'Chatamari', 'Newari Khaja Set'],
      features: ['Heritage setting', 'Budget-friendly', 'Old town location'],
    },
    verified: true,
  },
  {
    name: 'Temple View Restro & BBQ',
    category: 'restaurant',
    ward: 2,
    description: 'Three-floor restaurant next to Uma Maheshwor Temple with rooftop dining and sweeping views of the Kathmandu Valley. Serves Newari khaja sets, BBQ, and grilled dishes.',
    address: 'Uma Maheshwor Temple Road, Ward 2, Kirtipur',
    phone: '',
    hours: 'Daily 12pm–10pm',
    location: { type: 'Point', coordinates: [85.27670, 27.68030] },
    meta: {
      cuisine: 'Newari / BBQ / Nepali',
      mustTry: ['Buff Newa Khaja Set', 'BBQ Chicken Wings', 'Grilled Chicken', 'Mix Chatamari', 'Plain Bara'],
      features: ['Rooftop', 'Valley view', 'Temple view', 'Private rooms'],
    },
    verified: true,
  },
  {
    name: 'View Point Restaurant',
    category: 'restaurant',
    ward: 2,
    description: 'Sunny rooftop restaurant near Uma Maheshwor Temple with panoramic views across the Kathmandu Valley. Serves traditional Newari set plates and vegetarian momos.',
    address: 'Kirtipur Height, Kirtipur 44618',
    phone: '9818251071',
    hours: 'Daily (hours vary)',
    location: { type: 'Point', coordinates: [85.27267, 27.67873] },
    meta: {
      cuisine: 'Newari / Nepali',
      mustTry: ['Newari Set Plate', 'Deep Fried Veg Momo'],
      features: ['Rooftop', 'Panoramic valley view', 'Family-friendly'],
      tripadvisor: '#7 of 10 in Kirtipur, 4.0/5 (6 reviews)',
    },
    verified: true,
  },
  {
    name: 'Mah-Kwah-Cha Garden Restro',
    category: 'restaurant',
    ward: 2,
    description: 'Tucked inside a small jungle behind Kirtipur Hospital, this garden restaurant offers a peaceful, green escape with Newari food and outdoor seating.',
    address: 'Devdhoka-2, Kirtipur Ring Road, Kirtipur 44618',
    phone: '9749495049',
    hours: 'Daily (hours vary)',
    location: { type: 'Point', coordinates: [85.27650, 27.67980] },
    meta: {
      cuisine: 'Newari',
      mustTry: ['Newari Khaja Set', 'Local snacks'],
      features: ['Garden setting', 'Jungle surroundings', 'Outdoor seating'],
    },
    verified: true,
  },
  {
    name: 'Falcha Newa Restaurant',
    category: 'restaurant',
    ward: 1,
    description: 'Newari restaurant in Thambahal serving traditional community food alongside regular Nepali dishes. Warm, local atmosphere.',
    address: 'Thambahal Ward-1, Kirtipur 44618',
    phone: '9861943113',
    hours: 'Daily (hours vary)',
    location: { type: 'Point', coordinates: [85.27480, 27.67870] },
    meta: {
      cuisine: 'Newari / Nepali',
      email: 'Thefalcha30@gmail.com',
    },
    verified: true,
  },
  {
    name: 'Ka:shi Cafe Lounge & Bar',
    category: 'restaurant',
    ward: 9,
    description: 'Modern cafe-lounge-bar near Nayabazar. Vibrant atmosphere with Nepali cuisine, freshly brewed coffee, handcrafted cocktails, and live music nights.',
    address: '17, Panga Dobato (near Sanima Bank), Nayabazar, Kirtipur',
    phone: '014333636',
    hours: 'Daily 10am–10pm',
    location: { type: 'Point', coordinates: [85.28100, 27.67550] },
    meta: {
      cuisine: 'Nepali / Cafe / Bar',
      mustTry: ['Handcrafted cocktails', 'Nepali cuisine', 'Coffee'],
      features: ['Live music', 'Outdoor seating', 'Bar', 'Delivery', 'Reservations'],
      email: 'kashicafekirtipur@gmail.com',
      tripadvisor: '4.7/5 (11 reviews)',
    },
    verified: true,
  },
  {
    ...
    category: 'restaurant',
    ward: 1,
    description: 'Highly-rated bistro on Salyanthan Road in Kirtipur old town, known for well-priced meals and a loyal local following.',
    address: 'Salyanthan Road, Kirtipur 44600',
    phone: '9761764411',
    hours: 'Daily (hours vary)',
    location: { type: 'Point', coordinates: [85.27294, 27.67725] },
    meta: {
      cuisine: 'Nepali / Newari',
      email: 'restaurantpalifal@gmail.com',
    },
    verified: true,
  },
  {
    name: 'Jhigu Sekuwa Chhen',
    category: 'restaurant',
    ward: 5,
    description: 'Local favourite for sekuwa — Nepali-style grilled and spiced meat skewers. A great spot for an affordable quick meal on Tyangla Chowk road.',
    address: 'Tyangla Chowk Marg, Kirtipur 44600',
    phone: '9823236973',
    hours: 'Daily (hours vary)',
    location: { type: 'Point', coordinates: [85.28100, 27.67700] },
    meta: {
      cuisine: 'Nepali / Sekuwa',
      mustTry: ['Buff Sekuwa', 'Chicken Sekuwa'],
    },
    verified: true,
  },
  {
    name: 'TU Campus Canteen',
    category: 'restaurant',
    ward: 4,
    description: 'Popular student canteen serving affordable dal-bhat, momos and snacks inside Tribhuvan University campus.',
    address: 'TU Campus, Kirtipur',
    phone: '',
    hours: 'Sun–Fri 7am–6pm',
    location: { type: 'Point', coordinates: [85.2840, 27.6795] },
    meta: { cuisine: 'Nepali', note: 'Campus entry required' },
    verified: true,
  },
  // --- BUSINESS ---
  {
